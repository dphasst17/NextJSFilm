...
const Header = () => {
    ...
    return <header className="relative w-full h-[7vh] 2xl:h-[5vh] flex flex-wrap items-center justify-start m-1 px-2 z-50">
        ...
        <nav className={`w-full lg:w-[95%] h-auto xl:h-full flex flex-wrap top-20 transition-all overflow-x-hidden items-center justify-between`}>
            ...
            <div className="navInfo w-[30%] lg:w-[35%] h-full flex flex-col-reverse md:flex-row-reverse items-center">
