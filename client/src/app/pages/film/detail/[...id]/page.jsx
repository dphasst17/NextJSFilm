        ...
        {data !== null && data?.map(d => <div className="relative w-full h-auto min-h-[300px] flex flex-wrap" key={d._id}>
            ...
            {!isLog && <div className="frame w-full h-auto min-h-[400px] flex flex-wrap justify-center content-start">
                ...
                <div className="form w-3/5 h-auto mb-8 flex flex-wrap justify-evenly z-10">
                    <Input {...register('name', { required: true })} radius="sm" isInvalid={errors.name ? true : false} type="text" label="Full name" className="w-1/5 mx-1" />
                    <Input {...register('email', { required: true })} radius="sm" isInvalid={errors.email ? true : false} type="email" label="Email" className="w-2/5 mx-1" />
                    <Input {...register('phone', { required: true })} radius="sm" isInvalid={errors.phone ? true : false} type="text" label="Phone" className="w-1/5 mx-1" />
                    ...
                    {isPaypal && <Payment props={{setIsPaypal,setStateForm,stateForm,count:1,price:1,title:d.title}}/>}
                </div>
            </div>}
        </div>)}
    </div>
