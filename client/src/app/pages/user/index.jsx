    ...
    return isLog && <div className='user w-full h-auto min-h-screen flex flex-wrap justify-around content-start'>
        ...
        <section className='ticket w-2/4 h-auto min-h-[300px] flex flex-wrap justify-center'>
            ...
            <div className='items w-full h-auto flex flex-wrap justify-center'>
                ...
                <Skeletons />
                <Skeletons /></>}
                <div className='ticket w-4/5 h-auto flex flex-wrap justify-center'>
                    {user?.map(u => u.ticket)[0].map(t => <div style={{backgroundImage:`url(${t.background})`,backgroundRepeat:'no-repeat',backgroundPosition:'center',backgroundSize:'100% 120%'}} className='ticketDetail w-full h-[200px] flex flex-wrap my-1 rounded-lg' key={t.idTicket}>
